...
import { Create, EditButton, required, BooleanInput, ReferenceInput, DateInput, email, NumberInput, TextInput, TabbedForm, FormTab } from 'admin-on-rest';
...
export default (props) => (
    <Create {...props} title="添加安全责任书信息" >
        <TabbedForm>
            ...
            <FormTab label="检查结果">
                <BooleanInput source="pre_jcjg.wgxx.sfy" label="是否有违规信息" validate={[ required ]} />
