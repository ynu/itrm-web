                ...
                <Create {...this.props} title="添加网站或应用系统" >
                    <TabbedForm>
                        ...
                        <FormTab label="服务器信息">
                            ...
                            { tgfs && tgfs !== 1 && <LongTextInput source="providerInfo.realServersText" 
                                label="服务器地址及端口，每行填写一个服务器地址及端口，网站托管在站群系统可不填"
                                defaultValue="113.55.12.153:80\n113.55.12.248:80" 
                                validate={[ required ]} 
                            /> }
                            { tgfs && tgfs !== 1 && <LongTextInput source="providerInfo.remark" label="网站不在站群系统的原因" validate={[ required ]} /> }
                        </FormTab>
                    </TabbedForm>
                </Create>
            </div>
